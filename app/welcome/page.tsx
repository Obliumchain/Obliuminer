        ...
        <div className="text-center animate-fade-in">
          ...
          <div className="mb-8 animate-slide-up" style={{ animationDelay: "0s" }}>
            <div className="flex items-center justify-center gap-3 mb-4">
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center shadow-lg shadow-primary/50">
                <span className="text-3xl font-display font-bold text-background">Ø</span>
              </div>
            </div>
          ...
          >
            {[
              ...
              { icon: "✨", title: "Convert to OBL", desc: "Every 2 weeks automatically" },
            ].map((feature, i) => (
              <div
                key={i}
                className="glass-panel p-6 group hover:border-primary/50 transition-all duration-300 hover:-translate-y-1"
              >
